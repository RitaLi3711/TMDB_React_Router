  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-gray-400 mb-6">Season {data.season_number}</p>
          ...
          {data.episodes.map((episode) => (
            ...
            >
              {episode.still_path ? (
                ...
                <div className="w-40 h-24 bg-gray-700 rounded flex items-center justify-center text-gray-500 text-sm">
                  No image
                </div>
              )}
